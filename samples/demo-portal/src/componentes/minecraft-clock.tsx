...
export const minecraftClockSvg = (rotation: number): string => {
    ...
    return svg`<svg width="180" height="180" viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_4_392)">
        <g clip-path="url(#clip1_4_392)">
        <mask id="mask0_4_392" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="24" y="24" width="132" height="132">
        ...
        <rect x="80" y="40" width="10" height="10" transform="rotate(-180 80 40)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="90" y="40" width="10" height="10" transform="rotate(-180 90 40)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="100" y="40" width="10" height="10" transform="rotate(-180 100 40)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="110" y="40" width="10" height="10" transform="rotate(-180 110 40)" fill="#6B6B6B" fill-opacity="0.1"/>
        ...
        <rect x="60" y="50" width="10" height="10" transform="rotate(-180 60 50)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="70" y="50" width="10" height="10" transform="rotate(-180 70 50)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="80" y="50" width="10" height="10" transform="rotate(-180 80 50)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="90" y="50" width="10" height="10" transform="rotate(-180 90 50)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="100" y="50" width="10" height="10" transform="rotate(-180 100 50)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="110" y="50" width="10" height="10" transform="rotate(-180 110 50)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="120" y="50" width="10" height="10" transform="rotate(-180 120 50)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="130" y="50" width="10" height="10" transform="rotate(-180 130 50)" fill="#6B6B6B" fill-opacity="0.1"/>
        ...
        <rect x="60" y="60" width="10" height="10" transform="rotate(-180 60 60)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="70" y="60" width="10" height="10" transform="rotate(-180 70 60)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="130" y="60" width="10" height="10" transform="rotate(-180 130 60)" fill="#6B6B6B" fill-opacity="0.1"/>
        ...
        <rect x="50" y="70" width="10" height="10" transform="rotate(-180 50 70)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="60" y="70" width="10" height="10" transform="rotate(-180 60 70)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="140" y="70" width="10" height="10" transform="rotate(-180 140 70)" fill="#6B6B6B" fill-opacity="0.1"/>
        ...
        <rect x="50" y="80" width="10" height="10" transform="rotate(-180 50 80)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="60" y="80" width="10" height="10" transform="rotate(-180 60 80)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="140" y="80" width="10" height="10" transform="rotate(-180 140 80)" fill="#6B6B6B" fill-opacity="0.1"/>
        ...
        <rect x="50" y="90" width="10" height="10" transform="rotate(-180 50 90)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="60" y="90" width="10" height="10" transform="rotate(-180 60 90)" fill="#6B6B6B" fill-opacity="0.1"/>
        ...
        <rect x="110" y="90" width="10" height="10" transform="rotate(-180 110 90)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="140" y="90" width="10" height="10" transform="rotate(-180 140 90)" fill="#6B6B6B" fill-opacity="0.1"/>
        ...
        <rect x="60" y="100" width="10" height="10" transform="rotate(-180 60 100)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="70" y="100" width="10" height="10" transform="rotate(-180 70 100)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="80" y="100" width="10" height="10" transform="rotate(-180 80 100)" fill="#6B6B6B" fill-opacity="0.1"/>
        ...
        <rect x="110" y="100" width="10" height="10" transform="rotate(-180 110 100)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="120" y="100" width="10" height="10" transform="rotate(-180 120 100)" fill="#6B6B6B" fill-opacity="0.1"/>
        <rect x="130" y="100" width="10" height="10" transform="rotate(-180 130 100)" fill="#6B6B6B" fill-opacity="0.1"/>
...
export function MinecraftClock({ rotation }: { rotation: number }) {
    return (
        <div className="minecraft-clock" dangerouslySetInnerHTML={{ __html: minecraftClockSvg(rotation) }} />
    );
}